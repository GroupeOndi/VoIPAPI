...
/**
 * CountryDetailed Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CountryDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Country-detailed';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['country_code']) && (mb_strlen($this->container['country_code']) > 10)) {
    ...
    public function setCode($code)
    {
        if ((mb_strlen($code) > 100)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CountryDetailed., must be smaller than or equal to 100.');
        }
    ...
    {
        if (!is_null($country_code) && (mb_strlen($country_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CountryDetailed., must be smaller than or equal to 10.');
        }
