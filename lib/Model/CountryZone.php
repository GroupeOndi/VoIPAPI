 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CountryZone implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Country_Zone';
    ...
    {
        if ((mb_strlen($en) > 55)) {
            throw new \InvalidArgumentException('invalid length for $en when calling CountryZone., must be smaller than or equal to 55.');
        }
    ...
    {
        if ((mb_strlen($es) > 55)) {
            throw new \InvalidArgumentException('invalid length for $es when calling CountryZone., must be smaller than or equal to 55.');
        }
    ...
    {
        if ((mb_strlen($ca) > 55)) {
            throw new \InvalidArgumentException('invalid length for $ca when calling CountryZone., must be smaller than or equal to 55.');
        }
    ...
    {
        if ((mb_strlen($it) > 55)) {
            throw new \InvalidArgumentException('invalid length for $it when calling CountryZone., must be smaller than or equal to 55.');
        }
