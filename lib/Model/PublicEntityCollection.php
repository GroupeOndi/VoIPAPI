...
/**
 * PublicEntityCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PublicEntityCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PublicEntity-collection';
    ...
    public function setIden($iden)
    {
        if ((mb_strlen($iden) > 100)) {
            throw new \InvalidArgumentException('invalid length for $iden when calling PublicEntityCollection., must be smaller than or equal to 100.');
        }
