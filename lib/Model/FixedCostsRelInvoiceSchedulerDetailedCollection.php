...
/**
 * FixedCostsRelInvoiceSchedulerDetailedCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FixedCostsRelInvoiceSchedulerDetailedCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FixedCostsRelInvoiceScheduler-detailedCollection';
    ...
    protected static $setters = [
        ...
        'invoice_scheduler' => 'setInvoiceScheduler'
    ];
    ...
    protected static $getters = [
        ...
        'invoice_scheduler' => 'getInvoiceScheduler'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['invoice_scheduler'] = isset($data['invoice_scheduler']) ? $data['invoice_scheduler'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['invoice_scheduler'] === null) {
            $invalidProperties[] = "'invoice_scheduler' can't be null";
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FixedCostsRelInvoiceSchedulerDetailedCollection., must be bigger than or equal to 0.');
        }
    ...
    {
        return $this->container['invoice_scheduler'];
    }
     ...
     * @return $this
     */
    public function setInvoiceScheduler($invoice_scheduler)
    {
        $this->container['invoice_scheduler'] = $invoice_scheduler;
