 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallCsvSchedulerDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallCsvScheduler-detailed';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CallCsvSchedulerDetailed., must be smaller than or equal to 40.');
        }
    ...
    public function setUnit($unit)
    {
        ...
        if ((mb_strlen($unit) > 30)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling CallCsvSchedulerDetailed., must be smaller than or equal to 30.');
        }
    ...
    public function setFrequency($frequency)
    {
        ...
        if (($frequency < 0)) {
            throw new \InvalidArgumentException('invalid value for $frequency when calling CallCsvSchedulerDetailed., must be bigger than or equal to 0.');
        }
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 140)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CallCsvSchedulerDetailed., must be smaller than or equal to 140.');
        }
    ...
    public function setLastExecutionError($last_execution_error)
    {
        if (!is_null($last_execution_error) && (mb_strlen($last_execution_error) > 300)) {
            throw new \InvalidArgumentException('invalid length for $last_execution_error when calling CallCsvSchedulerDetailed., must be smaller than or equal to 300.');
        }
