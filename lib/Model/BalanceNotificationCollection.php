...
/**
 * BalanceNotificationCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BalanceNotificationCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BalanceNotification-collection';
    ...
    public function setToAddress($to_address)
    {
        if (!is_null($to_address) && (mb_strlen($to_address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $to_address when calling BalanceNotificationCollection., must be smaller than or equal to 255.');
        }
