 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RatingPlanDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RatingPlan-detailed';
    ...
    public function setTimingType($timing_type)
    {
        ...
        if (!is_null($timing_type) && (mb_strlen($timing_type) > 10)) {
            throw new \InvalidArgumentException('invalid length for $timing_type when calling RatingPlanDetailed., must be smaller than or equal to 10.');
        }
