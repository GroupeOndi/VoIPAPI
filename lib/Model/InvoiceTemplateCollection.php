...
/**
 * InvoiceTemplateCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InvoiceTemplateCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InvoiceTemplate-collection';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 55)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InvoiceTemplateCollection., must be smaller than or equal to 55.');
        }
