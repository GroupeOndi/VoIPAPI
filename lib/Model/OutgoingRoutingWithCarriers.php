 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OutgoingRoutingWithCarriers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OutgoingRouting-withCarriers';
    ...
    public function setPriority($priority)
    {
        ...
        if (($priority < 0)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling OutgoingRoutingWithCarriers., must be bigger than or equal to 0.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling OutgoingRoutingWithCarriers., must be bigger than or equal to 0.');
        }
    ...
    public function setRoutingMode($routing_mode)
    {
        ...
        if (!is_null($routing_mode) && (mb_strlen($routing_mode) > 25)) {
            throw new \InvalidArgumentException('invalid length for $routing_mode when calling OutgoingRoutingWithCarriers., must be smaller than or equal to 25.');
        }
    ...
    public function setPrefix($prefix)
    {
        if (!is_null($prefix) && (mb_strlen($prefix) > 25)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling OutgoingRoutingWithCarriers., must be smaller than or equal to 25.');
        }
    ...
    public function setClid($clid)
    {
        if (!is_null($clid) && (mb_strlen($clid) > 25)) {
            throw new \InvalidArgumentException('invalid length for $clid when calling OutgoingRoutingWithCarriers., must be smaller than or equal to 25.');
        }
