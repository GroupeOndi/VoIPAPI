 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FixedCostsRelInvoiceSchedulerDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FixedCostsRelInvoiceScheduler-detailed';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FixedCostsRelInvoiceSchedulerDetailed., must be bigger than or equal to 0.');
        }
