 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RoutingPattern implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RoutingPattern';
    ...
    public function setPrefix($prefix)
    {
        if ((mb_strlen($prefix) > 80)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling RoutingPattern., must be smaller than or equal to 80.');
        }
