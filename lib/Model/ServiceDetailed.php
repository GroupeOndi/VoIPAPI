...
/**
 * ServiceDetailed Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ServiceDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Service-detailed';
    ...
    public function setIden($iden)
    {
        if ((mb_strlen($iden) > 50)) {
            throw new \InvalidArgumentException('invalid length for $iden when calling ServiceDetailed., must be smaller than or equal to 50.');
        }
    ...
    public function setDefaultCode($default_code)
    {
        if ((mb_strlen($default_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $default_code when calling ServiceDetailed., must be smaller than or equal to 3.');
        }
