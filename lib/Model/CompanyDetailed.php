...
class CompanyDetailed implements ModelInterface, ArrayAccess
{
    ...
    public function setMaxCalls($max_calls)
    {
        ...
        if (($max_calls < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_calls when calling CompanyDetailed., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxDailyUsage($max_daily_usage)
    {
        ...
        if (($max_daily_usage < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_daily_usage when calling CompanyDetailed., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxDailyUsageEmail($max_daily_usage_email)
    {
        if (!is_null($max_daily_usage_email) && (mb_strlen($max_daily_usage_email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $max_daily_usage_email when calling CompanyDetailed., must be smaller than or equal to 100.');
        }
    ...
    public function setPostalAddress($postal_address)
    {
        if ((mb_strlen($postal_address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $postal_address when calling CompanyDetailed., must be smaller than or equal to 255.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if ((mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling CompanyDetailed., must be smaller than or equal to 10.');
        }
    ...
    public function setTown($town)
    {
        if ((mb_strlen($town) > 255)) {
            throw new \InvalidArgumentException('invalid length for $town when calling CompanyDetailed., must be smaller than or equal to 255.');
        }
    ...
    public function setProvince($province)
    {
        if ((mb_strlen($province) > 255)) {
            throw new \InvalidArgumentException('invalid length for $province when calling CompanyDetailed., must be smaller than or equal to 255.');
        }
    ...
    public function setCountryName($country_name)
    {
        if ((mb_strlen($country_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $country_name when calling CompanyDetailed., must be smaller than or equal to 255.');
        }
    ...
    public function setExternallyextraopts($externallyextraopts)
    {
        if (!is_null($externallyextraopts) && (mb_strlen($externallyextraopts) > 65535)) {
            throw new \InvalidArgumentException('invalid length for $externallyextraopts when calling CompanyDetailed., must be smaller than or equal to 65535.');
        }
    ...
    public function setBillingMethod($billing_method)
    {
        ...
        if ((mb_strlen($billing_method) > 25)) {
            throw new \InvalidArgumentException('invalid length for $billing_method when calling CompanyDetailed., must be smaller than or equal to 25.');
        }
