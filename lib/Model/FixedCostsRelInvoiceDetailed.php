 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FixedCostsRelInvoiceDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FixedCostsRelInvoice-detailed';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FixedCostsRelInvoiceDetailed., must be bigger than or equal to 0.');
        }
