...
/**
 * ResidentialDevice Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResidentialDevice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResidentialDevice';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 65)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ResidentialDevice., must be smaller than or equal to 65.');
        }
    ...
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ResidentialDevice., must be smaller than or equal to 500.');
        }
    ...
    public function setTransport($transport)
    {
        ...
        if (!is_null($transport) && (mb_strlen($transport) > 25)) {
            throw new \InvalidArgumentException('invalid length for $transport when calling ResidentialDevice., must be smaller than or equal to 25.');
        }
    ...
    public function setIp($ip)
    {
        if (!is_null($ip) && (mb_strlen($ip) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ip when calling ResidentialDevice., must be smaller than or equal to 50.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port < 0)) {
            throw new \InvalidArgumentException('invalid value for $port when calling ResidentialDevice., must be bigger than or equal to 0.');
        }
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 64)) {
            throw new \InvalidArgumentException('invalid length for $password when calling ResidentialDevice., must be smaller than or equal to 64.');
        }
    ...
    public function setAllow($allow)
    {
        if ((mb_strlen($allow) > 200)) {
            throw new \InvalidArgumentException('invalid length for $allow when calling ResidentialDevice., must be smaller than or equal to 200.');
        }
    ...
    public function setFromDomain($from_domain)
    {
        if (!is_null($from_domain) && (mb_strlen($from_domain) > 190)) {
            throw new \InvalidArgumentException('invalid length for $from_domain when calling ResidentialDevice., must be smaller than or equal to 190.');
        }
    ...
    public function setMaxCalls($max_calls)
    {
        ...
        if (($max_calls < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_calls when calling ResidentialDevice., must be bigger than or equal to 0.');
        }
