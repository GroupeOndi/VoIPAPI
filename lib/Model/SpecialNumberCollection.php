...
/**
 * SpecialNumberCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SpecialNumberCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SpecialNumber-collection';
    ...
    public function setNumber($number)
    {
        if ((mb_strlen($number) > 25)) {
            throw new \InvalidArgumentException('invalid length for $number when calling SpecialNumberCollection., must be smaller than or equal to 25.');
        }
    ...
    public function setDisableCdr($disable_cdr)
    {
        ...
        if (($disable_cdr < 0)) {
            throw new \InvalidArgumentException('invalid value for $disable_cdr when calling SpecialNumberCollection., must be bigger than or equal to 0.');
        }
