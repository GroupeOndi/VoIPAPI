...
/**
 * DdiProviderRegistration Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DdiProviderRegistration implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DdiProviderRegistration';
    ...
    public function setUsername($username)
    {
        if ((mb_strlen($username) > 64)) {
            throw new \InvalidArgumentException('invalid length for $username when calling DdiProviderRegistration., must be smaller than or equal to 64.');
        }
    ...
    public function setDomain($domain)
    {
        if ((mb_strlen($domain) > 190)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling DdiProviderRegistration., must be smaller than or equal to 190.');
        }
    ...
    public function setRealm($realm)
    {
        if ((mb_strlen($realm) > 64)) {
            throw new \InvalidArgumentException('invalid length for $realm when calling DdiProviderRegistration., must be smaller than or equal to 64.');
        }
    ...
    public function setAuthUsername($auth_username)
    {
        if ((mb_strlen($auth_username) > 64)) {
            throw new \InvalidArgumentException('invalid length for $auth_username when calling DdiProviderRegistration., must be smaller than or equal to 64.');
        }
    ...
    public function setAuthPassword($auth_password)
    {
        if ((mb_strlen($auth_password) > 64)) {
            throw new \InvalidArgumentException('invalid length for $auth_password when calling DdiProviderRegistration., must be smaller than or equal to 64.');
        }
    ...
    public function setAuthProxy($auth_proxy)
    {
        if ((mb_strlen($auth_proxy) > 64)) {
            throw new \InvalidArgumentException('invalid length for $auth_proxy when calling DdiProviderRegistration., must be smaller than or equal to 64.');
        }
    ...
    public function setContactUsername($contact_username)
    {
        if ((mb_strlen($contact_username) > 64)) {
            throw new \InvalidArgumentException('invalid length for $contact_username when calling DdiProviderRegistration., must be smaller than or equal to 64.');
        }
