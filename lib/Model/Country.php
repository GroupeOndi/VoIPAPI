...
class Country implements ModelInterface, ArrayAccess
{
    ...
    public function setCode($code)
    {
        if ((mb_strlen($code) > 100)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Country., must be smaller than or equal to 100.');
        }
    ...
    public function setCountryCode($country_code)
    {
        if (!is_null($country_code) && (mb_strlen($country_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling Country., must be smaller than or equal to 10.');
        }
