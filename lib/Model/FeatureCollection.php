...
class FeatureCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Feature-collection';
    ...
    public function setIden($iden)
    {
        if ((mb_strlen($iden) > 100)) {
            throw new \InvalidArgumentException('invalid length for $iden when calling FeatureCollection., must be smaller than or equal to 100.');
        }
