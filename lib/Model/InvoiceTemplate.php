...
class InvoiceTemplate implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 55)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InvoiceTemplate., must be smaller than or equal to 55.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 300)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InvoiceTemplate., must be smaller than or equal to 300.');
        }
    ...
    public function setTemplate($template)
    {
        if ((mb_strlen($template) > 65535)) {
            throw new \InvalidArgumentException('invalid length for $template when calling InvoiceTemplate., must be smaller than or equal to 65535.');
        }
    ...
    public function setTemplateHeader($template_header)
    {
        if (!is_null($template_header) && (mb_strlen($template_header) > 65535)) {
            throw new \InvalidArgumentException('invalid length for $template_header when calling InvoiceTemplate., must be smaller than or equal to 65535.');
        }
    ...
    public function setTemplateFooter($template_footer)
    {
        if (!is_null($template_footer) && (mb_strlen($template_footer) > 65535)) {
            throw new \InvalidArgumentException('invalid length for $template_footer when calling InvoiceTemplate., must be smaller than or equal to 65535.');
        }
