...
/**
 * AdministratorCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AdministratorCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Administrator-collection';
    ...
    public function setUsername($username)
    {
        if ((mb_strlen($username) > 65)) {
            throw new \InvalidArgumentException('invalid length for $username when calling AdministratorCollection., must be smaller than or equal to 65.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AdministratorCollection., must be smaller than or equal to 100.');
        }
    ...
    public function setLastname($lastname)
    {
        if (!is_null($lastname) && (mb_strlen($lastname) > 100)) {
            throw new \InvalidArgumentException('invalid length for $lastname when calling AdministratorCollection., must be smaller than or equal to 100.');
        }
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $email when calling AdministratorCollection., must be smaller than or equal to 100.');
        }
