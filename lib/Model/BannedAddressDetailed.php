...
/**
 * BannedAddressDetailed Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BannedAddressDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BannedAddress-detailed';
    ...
    public function setIp($ip)
    {
        if (!is_null($ip) && (mb_strlen($ip) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ip when calling BannedAddressDetailed., must be smaller than or equal to 50.');
        }
    ...
    public function setBlocker($blocker)
    {
        ...
        if (!is_null($blocker) && (mb_strlen($blocker) > 50)) {
            throw new \InvalidArgumentException('invalid length for $blocker when calling BannedAddressDetailed., must be smaller than or equal to 50.');
        }
    ...
    public function setAor($aor)
    {
        if (!is_null($aor) && (mb_strlen($aor) > 300)) {
            throw new \InvalidArgumentException('invalid length for $aor when calling BannedAddressDetailed., must be smaller than or equal to 300.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 100)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BannedAddressDetailed., must be smaller than or equal to 100.');
        }
