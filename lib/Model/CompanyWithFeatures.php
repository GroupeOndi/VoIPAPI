...
/**
 * CompanyWithFeatures Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyWithFeatures implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Company-withFeatures';
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $type when calling CompanyWithFeatures., must be smaller than or equal to 25.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CompanyWithFeatures., must be smaller than or equal to 80.');
        }
    ...
    public function setDomainUsers($domain_users)
    {
        if (!is_null($domain_users) && (mb_strlen($domain_users) > 190)) {
            throw new \InvalidArgumentException('invalid length for $domain_users when calling CompanyWithFeatures., must be smaller than or equal to 190.');
        }
    ...
    {
        if ((mb_strlen($nif) > 25)) {
            throw new \InvalidArgumentException('invalid length for $nif when calling CompanyWithFeatures., must be smaller than or equal to 25.');
        }
    ...
    public function setMaxCalls($max_calls)
    {
        ...
        if (($max_calls < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_calls when calling CompanyWithFeatures., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxDailyUsage($max_daily_usage)
    {
        ...
        if (($max_daily_usage < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_daily_usage when calling CompanyWithFeatures., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxDailyUsageEmail($max_daily_usage_email)
    {
        if (!is_null($max_daily_usage_email) && (mb_strlen($max_daily_usage_email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $max_daily_usage_email when calling CompanyWithFeatures., must be smaller than or equal to 100.');
        }
    ...
    public function setPostalAddress($postal_address)
    {
        if ((mb_strlen($postal_address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $postal_address when calling CompanyWithFeatures., must be smaller than or equal to 255.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if ((mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling CompanyWithFeatures., must be smaller than or equal to 10.');
        }
    ...
    public function setTown($town)
    {
        if ((mb_strlen($town) > 255)) {
            throw new \InvalidArgumentException('invalid length for $town when calling CompanyWithFeatures., must be smaller than or equal to 255.');
        }
    ...
    public function setProvince($province)
    {
        if ((mb_strlen($province) > 255)) {
            throw new \InvalidArgumentException('invalid length for $province when calling CompanyWithFeatures., must be smaller than or equal to 255.');
        }
    ...
    public function setCountryName($country_name)
    {
        if ((mb_strlen($country_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $country_name when calling CompanyWithFeatures., must be smaller than or equal to 255.');
        }
    ...
    public function setOnDemandRecordCode($on_demand_record_code)
    {
        if (!is_null($on_demand_record_code) && (mb_strlen($on_demand_record_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $on_demand_record_code when calling CompanyWithFeatures., must be smaller than or equal to 3.');
        }
    ...
    public function setExternallyextraopts($externallyextraopts)
    {
        if (!is_null($externallyextraopts) && (mb_strlen($externallyextraopts) > 65535)) {
            throw new \InvalidArgumentException('invalid length for $externallyextraopts when calling CompanyWithFeatures., must be smaller than or equal to 65535.');
        }
    ...
    public function setBillingMethod($billing_method)
    {
        ...
        if ((mb_strlen($billing_method) > 25)) {
            throw new \InvalidArgumentException('invalid length for $billing_method when calling CompanyWithFeatures., must be smaller than or equal to 25.');
        }
     ...
     * Sets feature_ids
     *
     * @param int[] $feature_ids Active feature ids
     *
     * @return $this
     */
