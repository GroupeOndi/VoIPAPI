...
/**
 * FeatureDetailed Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FeatureDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Feature-detailed';
    ...
    public function setIden($iden)
    {
        if ((mb_strlen($iden) > 100)) {
            throw new \InvalidArgumentException('invalid length for $iden when calling FeatureDetailed., must be smaller than or equal to 100.');
        }
