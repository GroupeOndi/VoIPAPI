<?php
/**
 * FixedCostsRelInvoiceDetailedCollection
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * FixedCostsRelInvoiceDetailedCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FixedCostsRelInvoiceDetailedCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FixedCostsRelInvoice-detailedCollection';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FixedCostsRelInvoiceDetailedCollection., must be bigger than or equal to 0.');
        }
