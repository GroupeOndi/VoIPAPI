...
/**
 * TransformationRuleCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransformationRuleCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransformationRule-collection';
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 10)) {
            throw new \InvalidArgumentException('invalid length for $type when calling TransformationRuleCollection., must be smaller than or equal to 10.');
        }
    ...
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 64)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TransformationRuleCollection., must be smaller than or equal to 64.');
        }
    ...
    public function setPriority($priority)
    {
        ...
        if (!is_null($priority) && ($priority < 0)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling TransformationRuleCollection., must be bigger than or equal to 0.');
        }
    ...
    public function setMatchExpr($match_expr)
    {
        if (!is_null($match_expr) && (mb_strlen($match_expr) > 128)) {
            throw new \InvalidArgumentException('invalid length for $match_expr when calling TransformationRuleCollection., must be smaller than or equal to 128.');
        }
    ...
    public function setReplaceExpr($replace_expr)
    {
        if (!is_null($replace_expr) && (mb_strlen($replace_expr) > 128)) {
            throw new \InvalidArgumentException('invalid length for $replace_expr when calling TransformationRuleCollection., must be smaller than or equal to 128.');
        }
