 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinationRateDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DestinationRate-detailed';
    ...
    public function setRateIncrement($rate_increment)
    {
        if ((mb_strlen($rate_increment) > 16)) {
            throw new \InvalidArgumentException('invalid length for $rate_increment when calling DestinationRateDetailed., must be smaller than or equal to 16.');
        }
    ...
    public function setGroupIntervalStart($group_interval_start)
    {
        if ((mb_strlen($group_interval_start) > 16)) {
            throw new \InvalidArgumentException('invalid length for $group_interval_start when calling DestinationRateDetailed., must be smaller than or equal to 16.');
        }
