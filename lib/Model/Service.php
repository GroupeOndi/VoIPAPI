...
class Service implements ModelInterface, ArrayAccess
{
    ...
    public function setIden($iden)
    {
        if ((mb_strlen($iden) > 50)) {
            throw new \InvalidArgumentException('invalid length for $iden when calling Service., must be smaller than or equal to 50.');
        }
    ...
    public function setDefaultCode($default_code)
    {
        if ((mb_strlen($default_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $default_code when calling Service., must be smaller than or equal to 3.');
        }
