...
/**
 * DestinationRateGroupName Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinationRateGroupName implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DestinationRateGroup_Name';
    ...
    {
        if ((mb_strlen($en) > 55)) {
            throw new \InvalidArgumentException('invalid length for $en when calling DestinationRateGroupName., must be smaller than or equal to 55.');
        }
    ...
    {
        if ((mb_strlen($es) > 55)) {
            throw new \InvalidArgumentException('invalid length for $es when calling DestinationRateGroupName., must be smaller than or equal to 55.');
        }
    ...
    {
        if ((mb_strlen($ca) > 55)) {
            throw new \InvalidArgumentException('invalid length for $ca when calling DestinationRateGroupName., must be smaller than or equal to 55.');
        }
    ...
    {
        if ((mb_strlen($it) > 55)) {
            throw new \InvalidArgumentException('invalid length for $it when calling DestinationRateGroupName., must be smaller than or equal to 55.');
        }
