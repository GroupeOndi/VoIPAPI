 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BrandDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Brand-detailed';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 75)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BrandDetailed., must be smaller than or equal to 75.');
        }
