 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CarrierServerDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CarrierServer-detailed';
    ...
    public function setIp($ip)
    {
        if (!is_null($ip) && (mb_strlen($ip) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ip when calling CarrierServerDetailed., must be smaller than or equal to 50.');
        }
    ...
    public function setHostname($hostname)
    {
        if (!is_null($hostname) && (mb_strlen($hostname) > 64)) {
            throw new \InvalidArgumentException('invalid length for $hostname when calling CarrierServerDetailed., must be smaller than or equal to 64.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port < 0)) {
            throw new \InvalidArgumentException('invalid value for $port when calling CarrierServerDetailed., must be bigger than or equal to 0.');
        }
    ...
    public function setUriScheme($uri_scheme)
    {
        ...
        if (!is_null($uri_scheme) && ($uri_scheme < 0)) {
            throw new \InvalidArgumentException('invalid value for $uri_scheme when calling CarrierServerDetailed., must be bigger than or equal to 0.');
        }
    ...
    public function setTransport($transport)
    {
        ...
        if (!is_null($transport) && ($transport < 0)) {
            throw new \InvalidArgumentException('invalid value for $transport when calling CarrierServerDetailed., must be bigger than or equal to 0.');
        }
    ...
    public function setAuthUser($auth_user)
    {
        if (!is_null($auth_user) && (mb_strlen($auth_user) > 64)) {
            throw new \InvalidArgumentException('invalid length for $auth_user when calling CarrierServerDetailed., must be smaller than or equal to 64.');
        }
    ...
    public function setAuthPassword($auth_password)
    {
        if (!is_null($auth_password) && (mb_strlen($auth_password) > 64)) {
            throw new \InvalidArgumentException('invalid length for $auth_password when calling CarrierServerDetailed., must be smaller than or equal to 64.');
        }
    ...
    public function setSipProxy($sip_proxy)
    {
        if (!is_null($sip_proxy) && (mb_strlen($sip_proxy) > 128)) {
            throw new \InvalidArgumentException('invalid length for $sip_proxy when calling CarrierServerDetailed., must be smaller than or equal to 128.');
        }
    ...
    public function setOutboundProxy($outbound_proxy)
    {
        if (!is_null($outbound_proxy) && (mb_strlen($outbound_proxy) > 128)) {
            throw new \InvalidArgumentException('invalid length for $outbound_proxy when calling CarrierServerDetailed., must be smaller than or equal to 128.');
        }
    ...
    public function setFromUser($from_user)
    {
        if (!is_null($from_user) && (mb_strlen($from_user) > 64)) {
            throw new \InvalidArgumentException('invalid length for $from_user when calling CarrierServerDetailed., must be smaller than or equal to 64.');
        }
    ...
    public function setFromDomain($from_domain)
    {
        if (!is_null($from_domain) && (mb_strlen($from_domain) > 190)) {
            throw new \InvalidArgumentException('invalid length for $from_domain when calling CarrierServerDetailed., must be smaller than or equal to 190.');
        }
