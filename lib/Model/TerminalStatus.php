 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TerminalStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Terminal-status';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TerminalStatus., must be smaller than or equal to 100.');
        }
