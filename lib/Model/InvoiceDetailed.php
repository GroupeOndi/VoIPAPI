...
/**
 * InvoiceDetailed Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InvoiceDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Invoice-detailed';
    ...
    protected static $swaggerTypes = [
        ...
        'scheduler' => '\Swagger\Client\Model\InvoiceScheduler'
    ];
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (mb_strlen($number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $number when calling InvoiceDetailed., must be smaller than or equal to 30.');
        }
    ...
    public function setStatus($status)
    {
        ...
        if (!is_null($status) && (mb_strlen($status) > 25)) {
            throw new \InvalidArgumentException('invalid length for $status when calling InvoiceDetailed., must be smaller than or equal to 25.');
        }
    ...
    public function setStatusMsg($status_msg)
    {
        if (!is_null($status_msg) && (mb_strlen($status_msg) > 140)) {
            throw new \InvalidArgumentException('invalid length for $status_msg when calling InvoiceDetailed., must be smaller than or equal to 140.');
        }
     ...
     * Sets scheduler
     *
     * @param \Swagger\Client\Model\InvoiceScheduler $scheduler scheduler
     *
     * @return $this
     */
