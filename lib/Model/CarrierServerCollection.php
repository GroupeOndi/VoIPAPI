...
/**
 * CarrierServerCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CarrierServerCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CarrierServer-collection';
    ...
    public function setIp($ip)
    {
        if (!is_null($ip) && (mb_strlen($ip) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ip when calling CarrierServerCollection., must be smaller than or equal to 50.');
        }
    ...
    public function setHostname($hostname)
    {
        if (!is_null($hostname) && (mb_strlen($hostname) > 64)) {
            throw new \InvalidArgumentException('invalid length for $hostname when calling CarrierServerCollection., must be smaller than or equal to 64.');
        }
    ...
    public function setSipProxy($sip_proxy)
    {
        if (!is_null($sip_proxy) && (mb_strlen($sip_proxy) > 128)) {
            throw new \InvalidArgumentException('invalid length for $sip_proxy when calling CarrierServerCollection., must be smaller than or equal to 128.');
        }
