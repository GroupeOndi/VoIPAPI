...
/**
 * WebPortalDetailed Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebPortalDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WebPortal-detailed';
    ...
    public function setUrl($url)
    {
        if ((mb_strlen($url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebPortalDetailed., must be smaller than or equal to 255.');
        }
    ...
    public function setKlearTheme($klear_theme)
    {
        if (!is_null($klear_theme) && (mb_strlen($klear_theme) > 200)) {
            throw new \InvalidArgumentException('invalid length for $klear_theme when calling WebPortalDetailed., must be smaller than or equal to 200.');
        }
    ...
    public function setUrlType($url_type)
    {
        ...
        if ((mb_strlen($url_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $url_type when calling WebPortalDetailed., must be smaller than or equal to 25.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WebPortalDetailed., must be smaller than or equal to 200.');
        }
    ...
    public function setUserTheme($user_theme)
    {
        if (!is_null($user_theme) && (mb_strlen($user_theme) > 200)) {
            throw new \InvalidArgumentException('invalid length for $user_theme when calling WebPortalDetailed., must be smaller than or equal to 200.');
        }
