...
/**
 * RoutingPatternName Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RoutingPatternName implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RoutingPattern_Name';
    ...
    {
        if ((mb_strlen($en) > 55)) {
            throw new \InvalidArgumentException('invalid length for $en when calling RoutingPatternName., must be smaller than or equal to 55.');
        }
    ...
    {
        if ((mb_strlen($es) > 55)) {
            throw new \InvalidArgumentException('invalid length for $es when calling RoutingPatternName., must be smaller than or equal to 55.');
        }
    ...
    {
        if ((mb_strlen($ca) > 55)) {
            throw new \InvalidArgumentException('invalid length for $ca when calling RoutingPatternName., must be smaller than or equal to 55.');
        }
    ...
    {
        if ((mb_strlen($it) > 55)) {
            throw new \InvalidArgumentException('invalid length for $it when calling RoutingPatternName., must be smaller than or equal to 55.');
        }
