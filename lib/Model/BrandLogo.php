 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BrandLogo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Brand_Logo';
    ...
    public function setFileSize($file_size)
    {
        ...
        if (!is_null($file_size) && ($file_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $file_size when calling BrandLogo., must be bigger than or equal to 0.');
        }
    ...
    public function setMimeType($mime_type)
    {
        if (!is_null($mime_type) && (mb_strlen($mime_type) > 80)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling BrandLogo., must be smaller than or equal to 80.');
        }
    ...
    public function setBaseName($base_name)
    {
        if (!is_null($base_name) && (mb_strlen($base_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $base_name when calling BrandLogo., must be smaller than or equal to 255.');
        }
