...
/**
 * InvoiceNumberSequenceDetailed Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InvoiceNumberSequenceDetailed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InvoiceNumberSequence-detailed';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InvoiceNumberSequenceDetailed., must be smaller than or equal to 40.');
        }
    ...
    public function setPrefix($prefix)
    {
        if ((mb_strlen($prefix) > 20)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling InvoiceNumberSequenceDetailed., must be smaller than or equal to 20.');
        }
    ...
    public function setSequenceLength($sequence_length)
    {
        ...
        if (($sequence_length < 0)) {
            throw new \InvalidArgumentException('invalid value for $sequence_length when calling InvoiceNumberSequenceDetailed., must be bigger than or equal to 0.');
        }
    ...
    public function setIncrement($increment)
    {
        ...
        if (($increment < 0)) {
            throw new \InvalidArgumentException('invalid value for $increment when calling InvoiceNumberSequenceDetailed., must be bigger than or equal to 0.');
        }
    ...
    public function setIteration($iteration)
    {
        ...
        if (($iteration < 0)) {
            throw new \InvalidArgumentException('invalid value for $iteration when calling InvoiceNumberSequenceDetailed., must be bigger than or equal to 0.');
        }
