...
/**
 * DestinationRate Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinationRate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DestinationRate';
    ...
    public function setRateIncrement($rate_increment)
    {
        if ((mb_strlen($rate_increment) > 16)) {
            throw new \InvalidArgumentException('invalid length for $rate_increment when calling DestinationRate., must be smaller than or equal to 16.');
        }
    ...
    public function setGroupIntervalStart($group_interval_start)
    {
        if ((mb_strlen($group_interval_start) > 16)) {
            throw new \InvalidArgumentException('invalid length for $group_interval_start when calling DestinationRate., must be smaller than or equal to 16.');
        }
