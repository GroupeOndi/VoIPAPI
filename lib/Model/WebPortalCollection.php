...
/**
 * WebPortalCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebPortalCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WebPortal-collection';
    ...
    public function setUrl($url)
    {
        if ((mb_strlen($url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebPortalCollection., must be smaller than or equal to 255.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WebPortalCollection., must be smaller than or equal to 200.');
        }
    ...
    public function setUrlType($url_type)
    {
        ...
        if ((mb_strlen($url_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $url_type when calling WebPortalCollection., must be smaller than or equal to 25.');
        }
