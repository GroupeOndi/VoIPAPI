...
/**
 * UsersAddressCollection Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UsersAddressCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UsersAddress-collection';
    ...
    public function setSourceAddress($source_address)
    {
        if ((mb_strlen($source_address) > 100)) {
            throw new \InvalidArgumentException('invalid length for $source_address when calling UsersAddressCollection., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UsersAddressCollection., must be smaller than or equal to 200.');
        }
